...
class App extends Component {
  ...
  myPigLatinCodeHere = () => {
    ...
    let translatedWordsArray = userInput.map((currentWord) => {
      ...
      // Create a conditional statement that evaluates if there are any vowels
      // If "y", (.slice) at the index
      // Store .slice return within a variable
      // + "ay"
      // if it starts with a

      // Create a conditional statement to figure out is there is any vowel, if none is present, find if "y" is available and use as vowel
